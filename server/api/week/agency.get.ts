...
export default defineEventHandler(async (event) => {
  ...
  const [dayCategories, timeslots, agencyBookings, allBookings, users, guestLists, guideAssignments] = await Promise.all([
  ...
  agencyBookings.forEach((booking: any) => {
    ...
    agencyBookingsBySlot.get(key)!.push(booking);
  });
  ...
  allBookings.forEach((booking: any) => {
    ...
    allBookingsBySlot.get(key)!.push(booking);
  });
